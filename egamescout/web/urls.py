...
urlpatterns = [
    ...
    path('admin/organizations/bulk-delete/', admin_views.admin_bulk_delete_organizations, name='admin_bulk_delete_organizations'),
    ...
    path('admin/players/bulk-delete/', admin_views.admin_bulk_delete_players, name='admin_bulk_delete_players'),
    ...
    path('admin/bidding/report/manual/', admin_views.admin_report_detail_manual, name='admin_report_detail_manual'),
    path('admin/bidding/report/season/<int:season_id>/', admin_views.admin_report_detail_season, name='admin_report_detail_season'),
